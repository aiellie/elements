...
const menuPopup = (variant: "glass" | "solid") =>
  cn(
    "bg-background/70 border border-border/40 dark:bg-background/70",
    "min-w-40 origin-(--transform-origin) rounded-xl p-1 shadow-xl transition-[opacity,scale] duration-150 ease-out data-starting-style:scale-95 data-starting-style:opacity-0 motion-reduce:transition-none data-closed:scale-95 data-closed:opacity-0 overflow-y-auto overflow-x-hidden",
    ...
    variant === "glass" &&
      ...
      "border-border/40 bg-background/70 backdrop-blur-xs dark:bg-background/70"
  )
