...
function BreadcrumbLink({
  ...
  return useRender({
    ...
    props: mergeProps<"a">(
      {
        className: cn(
          "rounded-sm border border-transparent transition-[color,border-color] duration-80 outline-none hover:text-link focus-visible:border-ring motion-reduce:transition-none",
          className
        ),
      },
      props
